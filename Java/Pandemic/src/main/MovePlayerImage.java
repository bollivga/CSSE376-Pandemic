...
/**
 * NOTE FROM JONATHAN: This is an example class on player movement that I've
 * found. I've been having issues with moving buffered images in JFrame so I've
 * imported this to test for our class on movement. I found that I actually had
 * an issue with the image I was attempting to display, it won't even show up
 * here. I'm keeping this class imported for now for reference as I build my
 * player movement.
 * 
 * I have made personal edits to this code as well.
 * 
 * @author René Cruz - G-Cross Studio 2011 and Jonathan Jungck - CSSE 376 -
 *         Spring 2014
 */
