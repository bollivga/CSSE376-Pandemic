 ...
 * 
 * The main game class that initializes all aspects of the game, including
 * the player hand, infections, and out breaks. Keeps track of all data.
 *
 */
public class PandemicGame{
    ...
    public static void nextPlayer(){
    	...
    	PandemicGame.p1 = PandemicGame.playerStorage.get(PandemicGame.currentPlayer);
    	PandemicGame.currentMoves = 0;
    	Board.changePlayer();
    }
